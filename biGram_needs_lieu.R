...
# Generate word cloud
bigram_needs_Ahouli <- wordcloud(words = bigram_freq_df$bigram, freq = bigram_freq_df$freq, scale = c(1, 0.35), 
...
# Generate word cloud
bigram_needs_Mibladen <- wordcloud(words = bigram_freq_df2$bigram, freq = bigram_freq_df2$freq, scale = c(1, 0.35), 
                                 colors = brewer.pal(8, "Dark2"), random.order = FALSE, max.words = 75)
...
ggsave("graphs/Bigram/besoin_lieu.png",
       width = 12, height = 8)
